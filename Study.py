...
t5 = Task(5, description="Identify the maximum of all Discounts, and display it in cell J4.", formula="",
          ...
          result_type=RESULTTYPE.VALUE, max_total=4)
t6 = Task(6, description="Calculate the average of all Item Prices, round the result to the nearest whole number, and display it in cell J5.", formula="",
          expected_result_cell="J5", expected_operations = "", expected_operands="",
          result_type=RESULTTYPE.VALUE, max_total=5)
t7 = Task(7, description="Calculate the Packaging Fee by multiplying the Delivery Fee with the maximum of all Quantities and the average of all Discounts, and rounding the result to the nearest whole number.", formula="",
